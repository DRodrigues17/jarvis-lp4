package br.org.fundatec.jarvis.webservice

import br.org.fundatec.jarvis.BuildConfig
...
object RetrofitNetworkClient {
    ...
    fun createNetworkClient(baseUrl: String = "https://fundatec.herokuapp.com/api/") =
        retrofitClient(
            baseUrl,
            httpClint(),
            moshi()
